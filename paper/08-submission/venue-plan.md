...
| Months | Milestone |
|---|---|
| 0 to 1 | Steps 1 to 3. Claim, lit map, pre-registration posted. |
| 1 to 4 | Step 4. Exposure, search, and layoff data. Frozen snapshot. |
| 4 to 6 | Step 5. Headline result and robustness. |
| 6 to 7 | Step 6, the draft. Step 7, the replication package. |
| 7 | Step 8. Post the working paper. |
| 7 to 12 | Journal submission and revisions. |

## 8.4 Before we hit submit

- [ ] The pre-registration link is in the paper.
- [ ] The replication package is archived with a DOI.
- [ ] The limitations section is honest about causation and saturation.
- [ ] The co-author has signed off.
- [ ] Funding and conflicts disclosed, per the brief.
